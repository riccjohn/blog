---
title: 'I Built an AI Chatbot in a Few Weeks. Here's What I Learned About RAG'
description: 'Yes, you can build an AI chatbot. This is how I learned RAG by making a D&D rules assistant.'
pubDate: '2026-02-04'
heroImage: '../../assets/images/blog_posts/how-to-start-learning-ai/malcolm-lightbody-x0GYwcFTex8-unsplash.jpg'
---

import { Image } from 'astro:assets'
import RepoLink from '../../components/RepoLink.astro'
import zeldaImage from '../../assets/images/blog_posts/how-to-start-learning-ai/its-dangerous.webp'
import singleChunkDiagram from '../../assets/images/blog_posts/how-to-start-learning-ai/single-doc.png'
import multiChunkDiagram from '../../assets/images/blog_posts/how-to-start-learning-ai/split-doc.png'
import grimoireOracleDemo from '../../assets/video/blog_posts/how-to-start-learning-ai/Grimoire_Oracle_Demo-01.mp4'
...
<figure>
    <Image
        ...
        alt="Diagram showing a user making a request to an AI agent, which then attempts to load a knowledge-base to get the answer from"
        class="mx-auto my-8 block rounded-lg shadow-lg"
    />
    <figcaption>
